<!--  This xsl:
    * rename Dynawo.Electrical.Machines in Dynawo.Electrical.Machines.OmegaRef
-->
    ...
    <xsl:template match="@name">
        ...
        <xsl:attribute name="name">
            <xsl:call-template name="string-replace-all">
                ...
                <xsl:with-param name="replace" select="'Dynawo.Electrical.Machines.Generator'" />
                <xsl:with-param name="by" select="'Dynawo.Electrical.Machines.OmegaRef.Generator'" />
            </xsl:call-template>
        </xsl:attribute>
    </xsl:template>
