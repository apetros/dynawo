    ...
    <xsl:template match="@initName">
        ...
        <xsl:attribute name="initName">
            <xsl:call-template name="string-replace-all">
                ...
                <xsl:with-param name="replace" select="'Dynawo.Electrical.Controls.Machines.VoltageRegulators.VRProportionalIntegral'" />
                <xsl:with-param name="by" select="'Dynawo.Electrical.Controls.Machines.VoltageRegulators.Simplified.VRProportionalIntegral'" />
            </xsl:call-template>
        </xsl:attribute>
    </xsl:template>
