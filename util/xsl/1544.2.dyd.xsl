<!--  This xsl:
    * rename vrremote_URegulated_value in vrremote_URegulated
-->
    ...
    <xsl:template match="@var1">
        ...
        <xsl:attribute name="var1">
            <xsl:call-template name="string-replace-all">
                ...
                <xsl:with-param name="replace" select="'vrremote_URegulated_value'" />
                <xsl:with-param name="by" select="'vrremote_URegulated'" />
            </xsl:call-template>
        </xsl:attribute>
    </xsl:template>
