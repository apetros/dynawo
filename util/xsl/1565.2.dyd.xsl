    ...
    <xsl:template match="@name">
        ...
        <xsl:attribute name="name">
            <xsl:call-template name="string-replace-all">
                ...
                <xsl:with-param name="replace" select="'Dynawo.Electrical.Controls.Machines.VoltageRegulators.VRProportional'" />
                <xsl:with-param name="by" select="'Dynawo.Electrical.Controls.Machines.VoltageRegulators.Simplified.VRProportional'" />
            </xsl:call-template>
        </xsl:attribute>
    </xsl:template>
