<!--  This xsl:
    * rename tapChangerLock_UMonitored in tapChangerBlocking_UMonitored
-->
    ...
    <xsl:template match="@var1">
        ...
        <xsl:attribute name="var1">
            <xsl:call-template name="string-replace-all">
                ...
                <xsl:with-param name="replace" select="'tapChangerLock_UMonitored'" />
                <xsl:with-param name="by" select="'tapChangerBlocking_UMonitored'" />
            </xsl:call-template>
        </xsl:attribute>
    </xsl:template>
