...
model GeneratorSynchronous "Synchronous machine"
  ...
  */
  ...
  Dynawo.Connectors.ImPin UStatorPu(value(start = UStator0Pu)) "Stator voltage amplitude in pu (base UNom)";
  ...
  Dynawo.Connectors.ImPin IRotorPu(value(start = IRotor0Pu)) "Rotor current in pu (base SNom, user-selected base voltage)";
