...
equation
  ...
  when QInj1RawPu <= QInj1MinPu then
    q1Status = QStatus.AbsorptionMax;
    limUQDown1 = true;
    limUQUp1 = false;
  elsewhen QInj1RawPu >= QInj1MaxPu then
  ...
  when QInj2RawPu <= QInj2MinPu then
    q2Status = QStatus.AbsorptionMax;
    limUQDown2 = true;
    limUQUp2 = false;
  elsewhen QInj2RawPu >= QInj2MaxPu then
    q2Status = QStatus.GenerationMax;
    limUQDown2 = false;
    limUQUp2 = true;
  elsewhen not modeU2 then
    q2Status = QStatus.Standard;
    limUQDown2 = true;
    limUQUp2 = true;
  elsewhen QInj2RawPu > QInj2MinPu and QInj2RawPu < QInj2MaxPu then
    q2Status = QStatus.Standard;
    limUQDown2 = false;
    limUQUp2 = false;
  end when;
