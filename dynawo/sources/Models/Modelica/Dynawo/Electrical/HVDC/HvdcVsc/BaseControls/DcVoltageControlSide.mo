...
model DcVoltageControlSide "DC voltage control side of the HVDC link"
  ...
  Modelica.Blocks.Interfaces.RealInput iqMod1Pu(start = 0) "Additional reactive current at terminal 1 in case of fault or overvoltage in pu (base SNom, UNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.BooleanOutput activateDeltaP(start = false) "If true, DeltaP is activated" annotation(
    Placement(visible = true, transformation(origin = {107, 40}, extent = {{-7, -7}, {7, 7}}, rotation = 0), iconTransformation(origin = {-110, 86}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput ipRefPu(start = Ip0Pu) "Active current reference in pu (base SNom, UNom) (DC to AC)" annotation(
    Placement(visible = true, transformation(origin = {107, 70}, extent = {{-7, -7}, {7, 7}}, rotation = 0), iconTransformation(origin = {110, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Dynawo.Electrical.HVDC.HvdcVsc.BaseControls.DcVoltageControl.DcVoltageControl dCVoltageControl(Ip0Pu = Ip0Pu, IpMaxPu = IpMaxPu, KiDc = KiDc, KpDc = KpDc, RDcPu = RDcPu, SNom = SNom, tMeasureU = tMeasureU, U0Pu = U0Pu, UDc0Pu = UDc0Pu, UDcRef0Pu = UDcRef0Pu, UDcRefMaxPu = UDcRefMaxPu, UDcRefMinPu = UDcRefMinPu) "DC voltage control for HVDC" annotation(
    Placement(visible = true, transformation(origin = {-30, 70}, extent = {{-30, -30}, {30, 30}}, rotation = 0)));
  Dynawo.Electrical.HVDC.HvdcVsc.BaseControls.AcVoltageControl.AcVoltageControl aCVoltageControl(InPu = InPu, Ip0Pu = Ip0Pu, Iq0Pu = Iq0Pu, IqModTableName = IqModTableName, KiAc = KiAc, KpAc = KpAc, LambdaPu = LambdaPu, P0Pu = P0Pu, Q0Pu = Q0Pu, QOpMaxPu = QOpMaxPu, QOpMinPu = QOpMinPu, QPMaxTableName = QPMaxTableName, QPMinTableName = QPMinTableName, QUMaxTableName = QUMaxTableName, QUMinTableName = QUMinTableName, SlopeQRefPu = SlopeQRefPu, SlopeURefPu = SlopeURefPu, TablesFile = TablesFile, tMeasure = tMeasure, tQ = tQ, U0Pu = U0Pu, ModeU0 = ModeU0) annotation(
    Placement(visible = true, transformation(origin = {-30, -70}, extent = {{-30, -30}, {30, 30}}, rotation = 0)));
...
equation
  ...
  connect(limitsCalculationUDc.activateDeltaP, activateDeltaP) annotation(
    Line(points = {{71, 34}, {71, 40}, {107, 40}}, color = {255, 0, 255}));
  connect(iqMod1Pu, limitsCalculationUDc.iqMod1Pu) annotation(
  ...
  annotation(preferredView = "diagram",
    Icon(graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}), Text(origin = {122, 112}, extent = {{-13, 8}, {20, -12}}, textString = "UDcRefPu"), Text(origin = {54, 111}, extent = {{-13, 8}, {13, -8}}, textString = "QRefPu"), Text(origin = {-10, 111}, extent = {{-13, 8}, {13, -8}}, textString = "URefPu"), Text(origin = {-77, 112}, extent = {{-13, 8}, {13, -8}}, textString = "modeU"), Text(origin = {-147, 101}, extent = {{-13, 8}, {39, -14}}, textString = "activateDeltaP"), Text(origin = {124, 53}, extent = {{-13, 8}, {13, -8}}, textString = "ipRefPu"), Text(origin = {123, -13}, extent = {{-13, 8}, {13, -8}}, textString = "iqRefPu"), Text(origin = {116, -126}, extent = {{-13, 8}, {1, -6}}, textString = "QPu"), Text(origin = {68, -128}, extent = {{-13, 8}, {1, -6}}, textString = "PPu"), Text(origin = {23, -128}, extent = {{-13, 8}, {1, -6}}, textString = "UPu"), Text(origin = {-24, -128}, extent = {{-13, 8}, {13, -8}}, textString = "blocked"), Text(origin = {-119, -17}, extent = {{-13, 8}, {8, -11}}, textString = "UDcPu"), Text(origin = {0, 51}, extent = {{-65, 27}, {65, -27}}, textString = "UDc Control"), Text(origin = {0, -53}, extent = {{-65, 27}, {65, -27}}, textString = "U/Q Control"), Text(origin = {-108, -50}, extent = {{-28, 11}, {1, -6}}, textString = "iqModPu"), Text(origin = {-104, 41}, extent = {{-28, 11}, {1, -6}}, textString = "iqMod1Pu")}));
