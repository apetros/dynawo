...
model GridFormingControlDispatchableVirtualOscillatorControl "Grid forming control with dispatchable virtual oscillator control"
  ...
  Modelica.Blocks.Interfaces.RealInput UdcSourceRefPu(start = UdcSource0Pu) "Reference DC voltage on the DC side in pu (base UdcNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput UdcSourceRefOutPu(start = UdcSource0Pu) "Reference DC voltage on the DC side in pu (base UNdcom)" annotation(
  ...
  Dynawo.Electrical.Controls.Converters.BaseControls.DispatchableVirtualOscillatorControl dispatchableVirtualOscillatorControl(Alpha = Alpha, DeltaVVId0 = DeltaVVId0, DeltaVVIq0 = DeltaVVIq0, Eta = Eta, IdPcc0Pu = IdPcc0Pu, IqPcc0Pu = IqPcc0Pu, KDvoc = KDvoc, PRef0Pu = PRef0Pu, QRef0Pu = QRef0Pu, Theta0 = Theta0, UFilterRef0Pu = UFilterRef0Pu, UdFilter0Pu = UdFilter0Pu, UqFilter0Pu = UqFilter0Pu) annotation(
...
equation
  ...
  connect(dispatchableVirtualOscillatorControl.uqFilterRefPu, voltageLoop.uqFilterRefPu) annotation(
    Line(points = {{-18, 60}, {-2, 60}}, color = {0, 0, 127}));
  ...
  connect(udFilterPu, dispatchableVirtualOscillatorControl.udFilterPu) annotation(
    Line(points = {{-130, -60}, {-45, -60}, {-45, 58}}, color = {0, 0, 127}));
  connect(uqFilterPu, dispatchableVirtualOscillatorControl.uqFilterPu) annotation(
    Line(points = {{-130, -80}, {-35, -80}, {-35, 58}}, color = {0, 0, 127}));
