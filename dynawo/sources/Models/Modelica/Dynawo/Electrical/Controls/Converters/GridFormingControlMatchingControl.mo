...
model GridFormingControlMatchingControl "Grid forming control with matching control"
  ...
  Dynawo.Electrical.Controls.Converters.BaseControls.MatchingControl matchingControl(DeltaVVId0 = DeltaVVId0, DeltaVVIq0 = DeltaVVIq0, KMatching = KMatching, Theta0 = Theta0, UFilterRef0Pu = UFilterRef0Pu, UdFilter0Pu = UdFilter0Pu, UdcSource0Pu = UdcSource0Pu, UdcSourceRef0Pu = UdcSourceRef0Pu, UqFilter0Pu = UqFilter0Pu) annotation(
...
equation
  ...
  connect(omegaRefPu, matchingControl.omegaRefPu) annotation(
    Line(points = {{-130, -40}, {-30, -40}, {-30, 58}}, color = {0, 0, 127}));
  connect(UdcSourcePu, matchingControl.UdcSourcePu) annotation(
    Line(points = {{-129, -140}, {-20, -140}, {-20, 58}}, color = {0, 0, 127}));
  ...
  connect(UdcSourceRefPu, matchingControl.UdcSourceRefPu) annotation(
    Line(points = {{-130, -120}, {-90, -120}, {-90, 100}, {-62, 100}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
