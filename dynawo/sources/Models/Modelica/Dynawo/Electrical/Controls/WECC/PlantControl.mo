...
model PlantControl "WECC PV Plant Control REPC"
  ...
  Modelica.Blocks.Nonlinear.Limiter PRefLim(uMax = FEMax, uMin = FEMin) annotation(
  ...
  Modelica.Blocks.Nonlinear.DeadZone deadZone(uMax = Dbd, uMin = -Dbd) annotation(
    Placement(visible = true, transformation(origin = {50, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Nonlinear.DeadZone deadZone1(uMax = FDbd2, uMin = -FDbd1) annotation(
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter(uMax = 0, uMin = -999) annotation(
    Placement(visible = true, transformation(origin = {-150, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax = 999, uMin = 0) annotation(
...
equation
  ...
  connect(freeze1.y, limPIDFreeze.freeze) annotation(
