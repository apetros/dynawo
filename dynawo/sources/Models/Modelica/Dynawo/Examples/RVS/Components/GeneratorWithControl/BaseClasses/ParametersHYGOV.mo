...
record ParametersHYGOV "Parameter sets for the HYGOV regulations of the RVS test system"
  ...
  type exciterParamNames = enumeration(KDroopPerm, KDroopTemp, tR, tF, tG, VelMax, OpeningGateMax, OpeningGateMin, tW, At, DTurb, FlowNoLoad) "Parameter names";

  // KDroopPerm, KDroopTemp, tR, tF, tG, VelMax, OpeningGateMax, OpeningGateMin, tW, At, DTurb, FlowNoLoad
