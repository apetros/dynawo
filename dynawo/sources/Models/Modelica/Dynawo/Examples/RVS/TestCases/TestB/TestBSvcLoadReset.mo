...
model TestBSvcLoadReset "RVS test system simulation case : line disconnection, with SVC and load reset"
...
equation
  ...
  annotation(preferredView = "diagram",
    experiment(StartTime = 0, StopTime = 120, Tolerance = 0.005, Interval = 0.01),
