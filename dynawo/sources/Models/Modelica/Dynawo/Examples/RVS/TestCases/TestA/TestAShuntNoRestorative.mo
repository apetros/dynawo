...
model TestAShuntNoRestorative "RVS test system simulation case : shunt connection, alpha-beta loads"
  ...
  parameter Real event_time_line_sw1 = 150;
  parameter Real event_time_line_sw2 = 150;
  parameter Real event_time_reactor110_sw1 = 150;
  parameter Real event_time_reactor110_sw2 = 150;
