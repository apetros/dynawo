...
model Network "RVS test grid with buses, lines and shunts"
  ...
  Dynawo.Electrical.Shunts.ShuntB line_reactor_106(BPu = B0Pu_line_reactor_106, i0Pu = i0Pu_line_reactor_106, s0Pu = s0Pu_line_reactor_106, u0Pu = u0Pu_line_reactor_106) annotation(
    Placement(visible = true, transformation(origin = {48, -172}, extent = {{-6, -6}, {6, 6}}, rotation = -90)));
  Dynawo.Electrical.Shunts.ShuntB line_reactor_110(BPu = B0Pu_line_reactor_110, i0Pu = i0Pu_line_reactor_110, s0Pu = s0Pu_line_reactor_110, u0Pu = u0Pu_line_reactor_110) annotation(
  ...
  parameter Types.VoltageModulePu U0Pu_line_reactor_106;
  parameter Types.Angle UPhase0_line_reactor_106;

  parameter Types.ReactivePowerPu Q0Pu_line_reactor_110;
  parameter Types.VoltageModulePu U0Pu_line_reactor_110;
  parameter Types.Angle UPhase0_line_reactor_110;

  final parameter Types.PerUnit B0Pu_line_reactor_106 = Q0Pu_line_reactor_106 / U0Pu_line_reactor_106 ^ 2;
  ...
  final parameter Types.PerUnit B0Pu_line_reactor_110 = Q0Pu_line_reactor_110 / U0Pu_line_reactor_110 ^ 2;
