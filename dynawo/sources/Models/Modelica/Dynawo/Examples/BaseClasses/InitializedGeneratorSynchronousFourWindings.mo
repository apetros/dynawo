...
model InitializedGeneratorSynchronousFourWindings "Model of synchronous generator with four windings and built-in initialization, for the Nordic 32 test system"
...
initial algorithm
  ...
  u0Pu.re := gen_init4.u0Pu.re;
  u0Pu.im := gen_init4.u0Pu.im;
  i0Pu.re := gen_init4.i0Pu.re;
  i0Pu.im := gen_init4.i0Pu.im;
  s0Pu.re := gen_init4.s0Pu.re;
  s0Pu.im := gen_init4.s0Pu.im;
  uStator0Pu.re := gen_init4.uStator0Pu.re;
  uStator0Pu.im := gen_init4.uStator0Pu.im;
  iStator0Pu.re := gen_init4.uStator0Pu.re;
  iStator0Pu.im := gen_init4.uStator0Pu.im;
  sStator0Pu.re := gen_init4.sStator0Pu.re;
  sStator0Pu.im := gen_init4.sStator0Pu.im;
  // dq0
...
end InitializedGeneratorSynchronousFourWindings;
