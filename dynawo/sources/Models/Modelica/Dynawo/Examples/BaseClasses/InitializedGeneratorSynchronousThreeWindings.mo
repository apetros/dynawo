...
initial algorithm
  ...
  u0Pu.re := gen_init3.u0Pu.re;
  u0Pu.im := gen_init3.u0Pu.im;
  i0Pu.re := gen_init3.i0Pu.re;
  i0Pu.im := gen_init3.i0Pu.im;
  s0Pu.re := gen_init3.s0Pu.re;
  s0Pu.im := gen_init3.s0Pu.im;
  uStator0Pu.re := gen_init3.uStator0Pu.re;
  uStator0Pu.im := gen_init3.uStator0Pu.im;
  iStator0Pu.re := gen_init3.iStator0Pu.re;
  iStator0Pu.im := gen_init3.iStator0Pu.im;
  sStator0Pu.re := gen_init3.sStator0Pu.re;
  sStator0Pu.im := gen_init3.sStator0Pu.im;
  // dq0
