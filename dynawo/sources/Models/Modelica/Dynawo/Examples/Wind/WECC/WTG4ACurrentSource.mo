...
model WTG4ACurrentSource "WECC Wind Type 4A Model (including the plant controller) - WTG4A - on infinite bus"
  ...
  Dynawo.Electrical.Wind.WECC.WTG4ACurrentSource WTG4A(DDn = 20, DPMax = 2, DPMin = -2, DUp = 0.001, Dbd = 0.01, Dbd1 = -0.05, Dbd2 = 0.05, Dshaft = 1.5, EMax = 0.5, EMin = -0.5, FDbd1 = 0.004, FDbd2 = 1, FEMax = 999, FEMin = -999, FreqFlag = true, Hg = 1, HoldIpMax = 0, HoldIq = 0, Ht = 5, IMaxPu = 1.3, Id0Pu = 0.67611, Iq0Pu = 0.26996, IqFrzPu = 0, Iqh1Pu = 1.1, Iql1Pu = -1.1, IqrMaxPu = 20, IqrMinPu = -20, Kc = 0, Ki = 1.5, KiPLL = 20, Kig = 2.36, Kp = 0.1, KpPLL = 3, Kpg = 0.05, Kqi = 0.7, Kqp = 1, Kqv = 2, Kshaft = 200, Kvi = 0.7, Kvp = 1, OmegaMaxPu = 1.5, OmegaMinPu = 0.5, P0Pu = -0.7, PF0 = 0.92871, PFlag = true, PInj0Pu = 0.7, PMaxPu = 1, PMinPu = 0, PPriority = false, PfFlag = false, Q0Pu = -0.2, QFlag = true, QInj0Pu = 0.2795, QMaxPu = 0.4, QMinPu = -0.4, RPu = 0, RateFlag = false, RefFlag = true, Rrpwr = 10, SNom = 100, Tiq = 0.01, U0Pu = 1.0, UInj0Pu = 1.03534, UMaxPu = 1.1, UMinPu = 0.9, UPhaseInj0 = 0.10159, VCompFlag = false, VDLIp11 = 1.1, VDLIp12 = 1.1, VDLIp21 = 1.15, VDLIp22 = 1, VDLIq11 = 1.1, VDLIq12 = 1.1, VDLIq21 = 1.15, VDLIq22 = 1, VFlag = true, VFrz = 0, VMaxPu = 1.1, VMinPu = 0.9, VRef0Pu = 0, VRef1Pu = 0, XPu = 0.15, i0Pu = Complex(-0.7, 0.2), iInj0Pu = Complex(0.7, -0.2), s0Pu = Complex(-0.7, -0.2), tFilterGC = 0.02, tFilterPC = 0.04, tFt = 1e-10, tFv = 0.1, tG = 0.02, tLag = 0.1, tP = 0.05, tPord = 0.01, tRv = 0.01, u0Pu = Complex(1, 0), uInj0Pu = Complex(1.03, 0.105)) annotation(
