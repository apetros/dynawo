...
model PVVoltageSource "WECC PV Vsource Model on infinite bus"
  ...
  Dynawo.Electrical.Photovoltaics.WECC.PVVoltageSource PV(DDn = 20, DPMax = 999, DPMin = -999, DUp = 0.001, Dbd = 0.01, Dbd1 = -0.1, Dbd2 = 0.1, EMax = 999, EMin = -999, FDbd1 = 0.004, FDbd2 = 1, FEMax = 999, FEMin = -999, FreqFlag = true, IMaxPu = 1.05, Id0Pu = 0.675978, Iq0Pu = 0.271493, Iqh1Pu = 2, Iql1Pu = -2, IqrMaxPu = 20, IqrMinPu = -20, Kc = 0, Ki = 1.5, KiPLL = 20, Kig = 2.36, Kp = 0.1, KpPLL = 3, Kpg = 0.05, Kqi = 0.5, Kqp = 1, Kqv = 2, Kvi = 1, Kvp = 1, OmegaMaxPu = 1.5, OmegaMinPu = 0.5, P0Pu = -0.7, PF0 = 0.92871, PInj0Pu = 0.7, PMaxPu = 1, PMinPu = 0, PPriority = false, PfFlag = false, Q0Pu = -0.2, QFlag = true, QInj0Pu = 0.2795, QMaxPu = 0.4, QMinPu = -0.4, RPu = 0, RSourcePu=0, RateFlag = false, RefFlag = true, Rrpwr = 10, SNom = 100, Tiq = 0.02, U0Pu = 1.0, UInj0Pu = 1.03534, UMaxPu = 1.1, UMinPu = 0.9, UdInj0Pu=1.030, UqInj0Pu = 0, VCompFlag = false, VFlag = true, VFrz = 0, VMaxPu = 1.1, VMinPu = 0.9, VRef0Pu = 1, XPu = 0.15, XSourcePu=0.1, i0Pu = Complex(-0.7, 0.2), tE=0.005, tFilterGC = 0.02, tFilterPC = 0.04, tFt = 1e-10, tFv = 0.1, tG = 0.02, tLag = 0.1, tP = 0.04, tPord = 0.02, tRv = 0.02, u0Pu = Complex(1, 0), uSource0Pu = Complex(1.05, 0.175), uInj0Pu = Complex(1.03, 0.105)) annotation(Placement(visible = true, transformation(origin = {20, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 180)));
