...
One model is implemented for computing various aggregations of bus voltages: \verb VoltageMeasurementUtilities  model.
...
These aggregations are computed only on a subset of the input bus voltages for which the associated \verb running  variables are \verb True .
