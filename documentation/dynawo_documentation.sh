...
\title{\huge{\Dynawo Documentation} \\ \LARGE{v1.7.0} \\
\vspace{10mm}
...
license_name=('\Dynawo' '\Dynawo Documentation' 'OpenModelica' 'SUNDIALS' 'SuiteSparse' 'Adept' 'Xerces-C++' 'Libxml2' 'PowSyBl' 'jQuery MIT' 'jQuery GPL' 'cpplint')
